package com.foodapp.springrest.entity;
...
import com.foodapp.springrest.entity.ListToStringConverter;

@Converter
public class ListToStringConverter implements AttributeConverter<List<String>, String> {

	private static final Logger LOGGER = LogManager.getLogger(ListToStringConverter.class);
